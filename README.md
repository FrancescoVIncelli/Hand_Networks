...
This project uses EEG signals acquired during the execution and imagination of the left- and right-hand movement, which are then analyzed to build the networks subtending each task and to compare their different properties in terms of organization, structure, and local indices.
